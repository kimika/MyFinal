...
boehner = Politician.create name: "John Boehner"
pelosi = Politician.create name: "Nancy Pelosi"
brown = Politician.create name: "Sherrod Brown"
...
# politicians = Psych.load("RAILS_ENV#{Rails.root}/db/legislators-current.yaml")
