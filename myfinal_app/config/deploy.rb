...
role :web, "myfinal_app.com"                          # Your HTTP server, Apache/etc
role :app, "myfinal_app.com"                         # This may be the same as your `Web` server
role :db,  "myfinal_app.com"   , :primary => true # This is where Rails migrations will run
